...
Veja o arquivo `README.md` para instruções completas: ele contém instruções de setup (variáveis de ambiente), comandos `docker-compose up`, exemplos de request cURL para criar jobs, e também um roadmap com próximos passos técnicos e de segurança.
